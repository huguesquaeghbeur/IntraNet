                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <div className="flex flex-row justify-around">
                        <Link to={'/collaborator/get'}>
                            <button className="w-30 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 focus:ring-offset-2 focus:ring-indigo-500" >Liste des collaborateurs</button>
                        </Link>

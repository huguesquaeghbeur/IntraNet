...
namespace IntraNetAPI.Services
{
    public class LoginService
    {
        ...
        public string GenerateToken(Collaborator c)
        {
                ...
                // Création du Token
                JwtSecurityToken jwt = new JwtSecurityToken(issuer: "infinIT", audience: "infinIT", claims: claims, signingCredentials: signingCredentials, expires: DateTime.Now.AddMinutes(30));
